...
class CardInfoCryptoTest extends Specification {
    ...
    def "CardInfoCrypto test : #description throw IllegalArgumentException"() {
        ...
        " "                     | "1234567890123456"  | "1125"              | "777"  || "transactionId is space"
        ...
        "20050418045376626998"  | "  "                | "1125"              | "777"  || "cardNumber is space"
        ...
        "20050418045376626998"  | "1234567890123456"  | " "                 | "777"  || "expirationMonthYear is space"
        ...
        "20050418045376626998"  | "1234567890123456"  | "1125"              | " "    || "cvc is space"
