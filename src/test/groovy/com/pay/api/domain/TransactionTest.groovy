...
class TransactionTest extends Specification {
    ...
    def "결제 시 #description 이면 IllegalArgumentException 이 발생한다."() {
        ...
        "1234567890123456"  | "1125"              | ""     | -1          | 1_000_000_000 | 1_000_000 || "installment is less than 0"
        "1234567890123456"  | "1125"              | ""     | 13          | 1_000_000_000 | 1_000_000 || "installment is greater than 12"
        "1234567890123456"  | "1125"              | "777"  | 0           | null          | 1_000_000 || "amount is null"
        "1234567890123456"  | "1125"              | ""     | 0           | 99            | 1_000_000 || "amount is less than 100"
        "1234567890123456"  | "1125"              | ""     | 0           | 1_000_000_001 | 1_000_000 || "amount is greater than 1_000_000_00"
    }
